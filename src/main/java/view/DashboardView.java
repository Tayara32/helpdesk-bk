...
public class DashboardView extends JFrame {
    ...
    private void carregarUtilizadores() {
        ...
        // Perfis disponíveis (carregados uma única vez)
        List<Perfil> listaPerfis = controller.listarPerfis();
        ...
        for (Utilizador u : lista) {
            ...
            Perfil perfil = listaPerfis.stream()
                    .filter(p -> p.getId() == u.getPerfilId())
                    .findFirst()
                    .orElse(null);

            String nomePerfil = (perfil != null) ? perfil.getNome() : "Indefinido";
        ...
        if (e.getType() == TableModelEvent.UPDATE) {
            ...
            try {
                ...
                if (perfilAntigo != null
                        && perfilAntigo.getNome().equalsIgnoreCase("Administrador")
                        && !perfil.getNome().equalsIgnoreCase("Administrador")
                        && nAdmins <= 1) {
                    ...
                    modelo.setValueAt(perfilAntigo.getNome(), linha, 3);
